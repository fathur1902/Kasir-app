    ...
    <div class="bg-white p-8 rounded-lg shadow">
        ...
        <form action="{{ route('settings.updatePassword') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input type="password" name="current_password" class="w-full p-3 rounded-xl shadow focus:outline-none"
                    required>
            </div>
            ...
            <div>
                ...
                <input type="password" name="new_password_confirmation"
                    class="w-full p-3 rounded-xl shadow focus:outline-none" required>
            </div>

            <button type="submit"
                class="bg-blue-400 text-white px-6 py-2 rounded-full font-semibold hover:bg-blue-500 transition">
                Change
            </button>
        </form>
    </div>
