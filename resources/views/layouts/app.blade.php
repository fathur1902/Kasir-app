    ...
    <div class="flex min-h-screen">
        ...
        <div id="sidebar" class="w-64 bg-blue-400 p-6 transition-all duration-300 rounded-xl">
            ...
            <nav>
                <ul>
                    <li class="mb-4">
                        <a href="{{ route('dashboard') }}" class="flex items-center p-2 rounded {{ request()->routeIs('dashboard') ? 'bg-white' : 'hover:bg-white' }}">
        ...
        <div class="flex-1 p-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                <a href="{{ route('pemasukan') }}" class="bg-white p-4 rounded-lg shadow flex items-center hover:bg-blue-400 transition active-card {{ request()->routeIs('pemasukan') ? 'bg-blue-400' : '' }}" id="pemasukan-card">
                ...
                <a href="{{ route('pengeluaran') }}" class="bg-white p-4 rounded-lg shadow flex items-center hover:bg-blue-400 transition active-card {{ request()->routeIs('pengeluaran') ? 'bg-blue-400' : '' }}" id="pengeluaran-card">
